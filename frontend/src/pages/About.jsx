  ...
  return (
    <div className="about-service">
      ...
      <span className="intro">
        <h3>서비스 소개</h3>
        <div>
          선박, 부표, 기타 물체를 인식하여 안전한 항해와 효율적인 해상 교통
          관리를 지원하기 위해, 실시간으로 객체를 인식하는 서비스입니다
        </div>
      </span>
      <br></br>
      <span className="intro">
      ...
      <span className="intro">
        <h3>서비스 목표</h3>
        <div>
          해양 사고를 사전에 방지하고, 선박 및 해양 생태계의 안전을 보장하는
          것이 저희의 목표입니다. 이를 통해 해양 산업에서의 효율성을 높이고,
          환경 보호와 안전한 항해에 기여하고자 합니다.
        </div>
      </span>
      <br></br>
      <span className="intro">
        ...
        <div>
          ...
          시스템이 자동으로 객체를 탐지하고 거리, 방위를 나타내며 충돌 위험
          여부를 분석합니다.
